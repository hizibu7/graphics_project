...
struct Object3D {
	...
	~Object3D() { delete tex; }
	void parse(const char* objName, const char* texName, float model_scale);
	void parse0(const char* objName, float model_scale);
	void display(float x, float y, float z, float angle_v, float angle_h);
};
